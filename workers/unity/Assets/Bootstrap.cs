...
namespace Improbable
{
    public class Bootstrap : MonoBehaviour, IBootstrapHandler
    {
        ...
        public void Start()
        {
            ...
            EngineConfiguration.Instance.UseInstrumentation = false;
            EngineConfiguration.Instance.IsDebugMode = false;
            EngineConfiguration.Instance.LinkProtocol = LinkProtocol;
            EngineConfiguration.Instance.AppName = "nordic_gamejam";
